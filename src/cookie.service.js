System.register(["@angular/core", "./cookie-options-provider", "./utils"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, cookie_options_provider_1, utils_1, CookieService;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
            },
            function (cookie_options_provider_1_1) {
                cookie_options_provider_1 = cookie_options_provider_1_1;
            },
            function (utils_1_1) {
                utils_1 = utils_1_1;
            }
        ...
        execute: function () {
            CookieService = (function () {
                ...
                CookieService.prototype.getObject = function (key) {
                    ...
                    return value ? utils_1.safeJsonParse(value) : value;
                };
                /**
                ...
                CookieService.prototype._cookieReader = function () {
                    ...
                    if (currentCookieString !== lastCookieString) {
                        ...
                        for (i = 0; i < cookieArray.length; i++) {
                            ...
                            if (index > 0) {
                                name = utils_1.safeDecodeURIComponent(cookie.substring(0, index));
                                // the first value that is seen for a cookie is the most
                                // specific one.  values for the same cookie name that
                                // follow are for less specific paths.
                                if (utils_1.isBlank(lastCookies[name])) {
                                    lastCookies[name] = utils_1.safeDecodeURIComponent(cookie.substring(index + 1));
                                }
                            }
                        }
                    }
                ...
                CookieService.prototype._buildCookieString = function (name, value, options) {
                    var opts = utils_1.mergeOptions(this.options, options);
                    var expires = opts.expires;
                    if (utils_1.isBlank(value)) {
                        expires = 'Thu, 01 Jan 1970 00:00:00 GMT';
                        value = '';
                    }
                    if (utils_1.isString(expires)) {
